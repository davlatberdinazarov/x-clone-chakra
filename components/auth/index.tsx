        ...
        <div className="flex flex-col justify-center md:justify-between gap-6 h-full md:h-[70vh]">
          ...
          <div className="w-full md:w-[60%]">
            ...
            <div className="flex flex-col space-y-2">
              <Button fullWidth secondary onClick={() => console.log("Google")}>
              ...
              <Button fullWidth secondary onClick={() => console.log("Github")}>
                <div className="flex gap-2 items-center justify-center">
                  <AiFillGithub />
                  Sign up with Github
                </div>
              ...
              <Button fullWidth onClick={onOpenRegisterModal}>
                {" "}
                Create account
              </Button>
          ...
          <div className="w-full md:w-[60%]">
            ...
            <Button onClick={onOpenLoginModal} fullWidth outline>
              Sign in
            </Button>
          </div>
        </div>
